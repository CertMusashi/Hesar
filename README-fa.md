...
- 🌐 **کدگذاری خروجی چندزبانه**: تبدیل داده‌های رمزنگاری شده به حروف فارسی، کره‌ای، چینی یا روسی — یا خروجی hex خام — برای اشتراک‌گذاری آسان و محتاطانه
...
در تب **تنظیمات**، نحوه نمایش خروجی رمزنگاری شده را انتخاب کنید:

| زبان | خط |
|------|----|
| فارسی | حروف فارسی |
| انگلیسی | hex خام |
| کره‌ای | هجاهای هانگول |
| چینی | کاراکترهای CJK |
| روسی | حروف سیریلیک |

فرستنده و گیرنده باید از همان تنظیم زبان خروجی استفاده کنند.
...
ورودی کاربر → استخراج کلید PBKDF2 → رمزنگاری AES-256-GCM
          → کدگذاری Hex → نقشه‌برداری کاراکترهای زبان انتخابی → خروجی
```
